...
<tr>
 <td height="26" background="${pageContext.request.contextPath}/skin/images/frame/frame/newlinebg3.gif">
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="${cus.id}" value="101" class="np"></td>
	<td>${cou.count}</td>
